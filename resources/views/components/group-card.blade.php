...
<div class="relative hover:translate-x-2 hover:translate-y-2 duration-300">
    <a href="{{ route('groups.show', ['group' => $group, 'grade' => $group->grade]) }}">
    ...
    <a class="min-h-16 bg-red-500  w-12  absolute right-2 -bottom-5 max-md:-right-5 max-md:bottom-10 max-md:rotate-90 max-md:hover:translate-x-3 md:hover:translate-y-3  duration-300"
        href="{{ route('groups.edit', ['group' => $group, 'grade' => $group->grade]) }}"></a>
</div>
